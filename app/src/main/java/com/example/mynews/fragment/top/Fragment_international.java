...
public class Fragment_international extends Fragment {//国际

    private RecyclerView recyclerView11;
    private View view=null;

    NewsAdapter2 newsAdapter2;
    List<Categoryitem> internationallist=new ArrayList<>();
    ...
    private void initview11(){
        ...
        recyclerView11.setLayoutManager(linearLayoutManager10);
        recyclerView11.addItemDecoration(new DividerGridItemDecoration(getContext()));
        recyclerView11.setItemAnimator(new DefaultItemAnimator());
        newsAdapter2 =new NewsAdapter2(internationallist,getContext());
        recyclerView11.setAdapter(newsAdapter2);
    }

    private void initinternationalnews(){
        JSONObject jsonObject = new JSONObject();
        String url = "http://v.juhe.cn/toutiao/index?type=guoji&is_filter=1&key="+ MyKey.newskey;
    ...
    private void  initnews1(){
        ...
        String type=null;
        try {
            type = URLEncoder.encode("国际", "utf-8");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                Log.i("=news1=", String.valueOf(internationallist.toString()));
                ...
                for (int i=0;i<newsList.size();i++){
                    if((newsList.get(i).getThumbnail_pic_s().equals("")||newsList.get(i).getThumbnail_pic_s()==null)) {
                        ...
                        internationallist.add(categoryitem);
                ...
                Log.i("=news1=", String.valueOf(internationallist));
